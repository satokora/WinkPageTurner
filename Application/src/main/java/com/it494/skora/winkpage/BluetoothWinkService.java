    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BluetoothWinkService.this) {
                        switch (mState) {
                        case STATE_LISTEN:
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                BluetoothWinkService.this.start();
                return;
            }
...
//     * 常駐を開始
//     */
//    public BluetoothWinkService startResident(Context context)
//    {
